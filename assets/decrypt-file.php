...
<body class="sidebar-mini fixed">
  <div class="wrapper">
    <header class="main-header hidden-print"><a class="logo" style="font-family: Fantasy;"
        href="index.php">KRIPTOGRAFI</a>
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img class="img-circle"
              src="https://png.pngtree.com/png-vector/20190525/ourlarge/pngtree-encryptionfilesfoldernetworksecure-white-glyph-icon-colo-png-image_1067194.jpg"
              alt="User Image">
          </div>
