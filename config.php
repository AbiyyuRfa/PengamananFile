<?php
$host = 'localhost:3307'; //Host yang digunakan Localhost atau 127.0.0.1
...
$connect = mysqli_connect($host, $user, $pass) or die(mysqli_error()); //Mencoba terhubung apabila Host, User, dan Pass Benar. Kalau tidak MySQL memberikan Notif Error
