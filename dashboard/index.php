    ...
    <nav id="sidebar" class="">
      ...
      <div class="nalika-profile">
        <div class="profile-dtl">
          <a href="#"><img src="img/amikom.png" alt="" /></a>
          <h2>
            <?php echo $data['fullname']; ?>
            <p class="designation icon" style="color:purle;">
          ...
          <ul class="metismenu" id="menu1">
            ...
            <li>
              <a class="nav-link" href="enkripsi.php" aria-expanded="false"><i
                  class="icon nalika-unlocked icon-wrap"></i> <span class="mini-click-non">Enkripsi</span></a>
            </li>
            <li>
              <a class="nav-link" href="dekripsi.php" aria-expanded="false"><i
                  class="icon nalika-unlocked icon-wrap"></i> <span class="mini-click-non">Dekripsi</span></a>
            </li>
          </ul>
        </nav>
      </div>
                ...
                <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                  ...
                  <div class="row vertical-center-box vertical-center-box-tablet">
                    ...
                    <div class="col-xs-9 cus-gh-hd-pro">
                      ...
                      ?>
                      <h2 class="text-right no-margin">
                        <?php echo $dataencrypt['totalencrypt']; ?>
                      </h2>
                    </div>
                  </div>
                </div>
                ...
                <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                  ...
                  <div class="row vertical-center-box vertical-center-box-tablet">
                    ...
                    <div class="col-xs-9 cus-gh-hd-pro">
                      ...
                      ?>
                      <h2 class="text-right no-margin">
                        <?php echo $datadecrypt['totaldecrypt']; ?>
                      </h2>
                    </div>
                  </div>
                </div>
